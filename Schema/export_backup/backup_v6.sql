...
CREATE TABLE `coordinator` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `coordinator_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
CREATE TABLE `examine` (
  ...
  PRIMARY KEY (`examiners_id`, `project_id`),
...
INSERT INTO `users` VALUES (2,'coordinator@utm.my','$2b$10$5dC5BcypJaGje43Q.KjuSukzqpbfT4mgx5dI57U7N1wHFQVQRc4Wu','coordinator','123567625','2026-06-13','2026-06-13',1,'MJIIT ',NULL,'hehe, hoho, clown'),(3,'test@gmail.com','$2b$10$q6xPpRPMjNj931ktxClDweIivNHUP6p4WNp6P3xCiNUwA8IqL50M2','test','3447688','2026-05-07','2026-05-07',0,NULL,'test','test'),(4001,'ali.abu@graduate.utm.my','$2b$10$dummyHashStringHere','Ali bin Abu','0123456781','2026-05-30','2026-05-30',0,NULL,NULL,NULL),(4002,'wong.mei@graduate.utm.my','$2b$10$dummyHashStringHere','Wong Mei Ling','0123456782','2026-05-30','2026-05-30',0,NULL,NULL,NULL),(4003,'siti.n@graduate.utm.my','$2b$10$dummyHashStringHere','Siti Nurhaliza','0123456783','2026-05-30','2026-05-30',0,NULL,NULL,NULL),(4004,'david.k@graduate.utm.my','$2b$10$dummyHashStringHere','David Kumar','0123456784','2026-05-30','2026-05-30',0,NULL,NULL,NULL),(4005,'lim.wei@graduate.utm.my','$2b$10$dummyHashStringHere','Lim Wei Jie','0123456785','2026-05-30','2026-05-30',0,NULL,NULL,NULL),(4016,'ali.abu@utm.my','$2b$10$dummyHashStringHere','Dr Ali bin Abu','0133456781','2026-05-30','2026-05-30',1,NULL,NULL,'llm, IOT, AL, LM'),(4017,'test@utm.my','$2b$10$dummyHashStringHere','Test Name','0123456789','2026-05-30','2026-05-30',1,'Test',NULL,'Test'),(4018,'siti.n@utm.my','$2b$10$dummyHashStringHere','Ts. Ir. Dr. Siti Nurhaliza','0128256783','2026-05-30','2026-05-30',1,NULL,NULL,NULL),(4019,'david.k@utm.my','$2b$10$dummyHashStringHere','Dr. David Kumar','0124456787','2026-05-30','2026-05-30',1,NULL,NULL,NULL),(4020,'lim.wei@utm.my','$2b$10$dummyHashStringHere','Dr. Lim Wei Jie','0123457585','2026-05-30','2026-05-30',1,NULL,NULL,NULL);
...
DELIMITER ;;
CREATE  PROCEDURE `sp_CreateCalendarSchedule`(
    IN p_fyp_session_id INT,
    IN p_user_id INT,
    IN p_class_id INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_DeleteCalendarSchedule`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetNonStudentUserDetail` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_GetNonStudentUserDetail`(
        IN p_user_id INT
    )
BEGIN
        SELECT 
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_GetRecentUsersByCategory`()
BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_GetSessionCalendarData`(IN p_session_id INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetStudentFYPDetail` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_GetStudentFYPDetail`(
        IN p_student_id INT
    )
BEGIN
        SELECT 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_get_all_session`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_lookup_user_role`(
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_SearchNonStudentUsers`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_select_session`(
	IN session_number int
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_SetActiveFYPSession`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_signup_normal_user`(
    IN p_email CHAR(255),
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `sp_UpdateCalendarSchedule`(
    IN p_time_table_id INT,
    IN p_user_id INT,
    IN p_class_id INT,
    IN p_schedule_json JSON
...
-- Dump completed on 2026-06-14  1:08:38
