          ...
          >
            ...
            <div v-if="msg.action === 'CONFIRM_CREATE_USER' && !msg.completed" class="w-full mt-3 bg-white p-4 rounded-lg border border-gray-200 text-black shadow-sm flex flex-col gap-3">
              ...
              <div class="flex flex-col gap-2 text-sm">
                ...
                <label class="flex flex-col text-gray-600 font-medium">Phone number: <input v-model="msg.payload.password" class="border px-2 py-1.5 w-full rounded focus:outline-none focus:border-[#5C001F] font-normal text-black"></label>
