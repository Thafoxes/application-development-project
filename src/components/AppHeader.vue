...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-[15px] shrink-0">
      <div class="h-[71.186px] lg:h-[45px] overflow-clip relative shrink-0 w-[210px] lg:w-[133px] flex items-center">
        <img
    ...
    <div v-if="user" class="flex items-center gap-[15px] shrink-0 relative">
      ...
      <button class="relative p-2 text-white hover:bg-white/10 rounded-full transition-colors">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 lg:h-6 lg:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
        </svg>
        <span class="absolute top-1 right-2 lg:top-0.5 lg:right-1.5 w-3 h-3 lg:w-2 lg:h-2 bg-red-500 rounded-full border-2 border-[#800000]"></span>
      </button>
      ...
      <div class="relative">
        ...
        >
          <div class="w-[35px] h-[35px] lg:w-[28px] lg:h-[28px] rounded-full bg-[#5c001f] flex items-center justify-center text-white font-bold text-lg lg:text-sm">
            {{ user.full_name ? user.full_name.charAt(0).toUpperCase() : 'U' }}
          </div>
          <p class="capitalize font-bold text-[24px] lg:text-[16px] text-white whitespace-nowrap font-['Inter']">
