...
<template>
  <div class="w-full md:w-auto shrink-0">
    ...
    <div v-if="isMobileOpen" @click="closeMobileSidebar"
      class="fixed inset-0 bg-black/60 backdrop-blur-xs z-[998] md:hidden transition-opacity"></div>
    ...
    <aside :class="[
      ...
      <div class="px-4 py-4 md:py-5 flex items-center justify-between border-b border-[#e1d5cc]/60 md:border-b-0">
        ...
        <button type="button" @click="closeMobileSidebar"
      ...
      <nav class="flex-1 px-3 pb-5 space-y-1 overflow-y-auto">
        <button v-for="item in navItems" :key="item.label" type="button" @click="navigateTo(item)" :class="[
