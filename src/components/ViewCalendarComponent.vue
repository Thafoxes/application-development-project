<template>
  <div class="flex flex-col lg:flex-row gap-6 h-full min-h-[800px] w-full font-sans">
    ...
    <aside class="w-full lg:w-80 flex flex-col bg-[#FFFFAB] border border-gray-200 rounded-xl overflow-hidden shrink-0 relative shadow-sm">
      <!-- Sidebar Header -->
      <div class="p-6 pb-2">
          ...
          <div v-show="accordions.lecturers" class="border-t border-gray-100 p-3 space-y-3">
            ...
            >
              ...
              <div class="flex items-center gap-2">
                <!-- Color Indicator -->
                <div class="w-2.5 h-2.5 rounded-full mt-0.5 shrink-0" :style="{ backgroundColor: schedule.color }"></div>
                <!-- Avatar Mock -->
          ...
          <div v-show="accordions.classes" class="border-t border-gray-100 p-3 space-y-3">
            ...
            >
              ...
              <div class="flex items-center gap-2 text-gray-700 min-w-0">
                <!-- Color Indicator -->
                <div class="w-2.5 h-2.5 rounded-full shrink-0" :style="{ backgroundColor: schedule.color }"></div>
      ...
      <div class="p-4 flex flex-col gap-2 mt-auto border-t border-[#d6d68b]">
        ...
        <router-link to="/edit-time-table" class="w-full bg-[#5C001E] hover:bg-[#4a0018] text-white font-bold py-3 rounded-md shadow text-xs transition-colors flex justify-center items-center gap-2">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
               <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
            </svg>
            </span> Edit time table
        </router-link>
      </div>
    </aside>
