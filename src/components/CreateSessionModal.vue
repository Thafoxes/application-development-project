...
<template>
  <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-[100] px-4 font-['Inter']">
    <div class="bg-white rounded-[15px] p-[30px] w-full max-w-[500px] shadow-2xl flex flex-col gap-4">
