...
<template>
  <div class="min-h-screen flex flex-col bg-[#e7ded3] w-full font-['Inter']">
    ...
    <div v-if="!user || Number(user.role_info?.is_coordinator) !== 1" class="flex-1 flex flex-col items-center justify-center text-center px-4">
      <h1 class="text-4xl font-bold text-[#5c001f] mb-4">Access Restricted</h1>
      <p class="text-xl text-gray-700">You do not have coordinator permissions to view this dashboard.</p>
    </div>
    ...
    <div v-else class="flex flex-1 w-full relative">
      ...
      <main class="flex-1 flex flex-col px-[50px] py-[30px] gap-8 overflow-y-auto">
        ...
        <div class="flex items-center justify-between w-full">
          ...
          <button class="bg-[#5c001f] text-white px-[24px] py-[16px] rounded-[8px] font-medium text-[16px] hover:bg-[#4a0019] transition-colors shadow-md">
            Create New Session
          </button>
        </div>
        ...
        <div class="bg-white border border-[#2f2f2f] rounded-[15px] p-[20px] flex flex-col gap-4 shadow-sm w-full">
          <h2 class="font-['Inter'] font-bold text-[32px] text-black">Quick Stats</h2>
          <div class="flex gap-[20px] w-full">
            <!-- Total Projects -->
            <div class="bg-[#00b424] rounded-[15px] p-[15px] flex items-start justify-between flex-1 shadow-md">
              <div>
            ...
            <!-- Needing Supervisor -->
            <div class="bg-[#ffe100] rounded-[15px] p-[15px] flex items-start justify-between flex-1 shadow-md">
              <div>
            ...
            <!-- Missed Deadline -->
            <div class="bg-[#ff3737] rounded-[15px] p-[15px] flex items-start justify-between flex-1 shadow-md">
              <div>
        ...
        <div class="bg-white rounded-[25px] p-[30px] flex flex-col gap-[20px] shadow-lg w-full">
          ...
          <button class="bg-[#5c001f] text-white px-[24px] py-[12px] rounded-full font-medium text-[16px] hover:bg-[#4a0019] transition-colors self-start mt-4 shadow-md">
            Manage Users & Data Import
          </button>
        </div>

        <!-- Alerts Table -->
        <div class="bg-white rounded-[25px] p-[30px] flex flex-col gap-[15px] shadow-lg w-full mb-10">
          ...
          <div class="border-2 border-black rounded-[5px] overflow-hidden">
            ...
            <div class="bg-[#f7f6fe] flex justify-between items-center p-[16px]">
              <div class="flex-1 text-[14px] font-medium text-center text-black">Proposal Submitted</div>
              <div class="flex-1 text-[14px] font-medium text-center text-black">Matt Dickerson</div>
