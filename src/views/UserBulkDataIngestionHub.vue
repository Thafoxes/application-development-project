...
const triggerSimulation = () => {
  rawImportedRows.value = [
    { id: 1, name: 'Ahmad Faiz', email: 'ahmad@graduate.utm.my', identifier: 'MC220101', status: 'ready' },
    { id: 2, name: 'Siti Nurhaliza', email: 'siti@graduate.utm.my', identifier: 'MC220102', status: 'ready' },
    ...
    { id: 5, name: 'Ali Bin Abu', email: 'ali@graduate.utm.my', identifier: 'MC220103', status: 'ready' },
    ...
    { id: 8, name: 'Wong Wei', email: 'wong.wei@graduate.utm.my', identifier: '', status: 'warning' },
    { id: 9, name: 'Fatima Zahra', email: 'fatima@graduate.utm.my', identifier: 'MC220105', status: 'ready' },
    { id: 10, name: 'Robert Chen', email: 'robert@company.com', identifier: 'CORP101', status: 'ready' },
    { id: 11, name: 'Dr. Zulkifli', email: 'zul@utm.my', identifier: 'ST0015', status: 'ready' },
    { id: 12, name: 'Aisyah', email: 'aisyah@graduate.utm.my', identifier: 'MC220106', status: 'ready' },
    ...
    { id: 15, name: 'Raju', email: 'raju@graduate.utm.my', identifier: 'MC220107', status: 'ready' },
  ]
}
...
const normalUsersData = computed(() => {
  return rawImportedRows.value.filter(row => 
  ...
  <div class="min-h-screen bg-gray-50 p-6 flex flex-col justify-between">
    ...
    <main class="flex-grow flex flex-col max-w-7xl mx-auto w-full space-y-6 mt-6 mb-10">
      ...
      <div class="bg-amber-50 text-amber-900 border border-amber-200 p-3 rounded-lg text-sm flex items-center space-x-3 shadow-sm">
        ...
        <span class="font-medium">File processed entirely in client-side memory. Grid validation flags are live.</span>
      </div>
      ...
      >
        <svg class="w-16 h-16 text-gray-300 group-hover:text-[#5C001F] mb-4 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
        </svg>
        <p class="text-gray-700 font-semibold text-lg">Click or Drag to Upload Target Target Data File</p>
        <p class="text-gray-400 text-sm mt-2 font-medium">Click to execute simulation hook (seeds 15 records)</p>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 flex-grow flex flex-col overflow-hidden">
        ...
        <div class="border-b border-gray-200 px-6 flex space-x-8 bg-gray-50/30">
          ...
          >
            ...
            <div v-if="activeTab === 'students'" class="absolute bottom-0 left-0 right-0 h-0.5 bg-[#F8BE17] rounded-t-md"></div>
          </button>
          <button 
          ...
          >
            ...
            <div v-if="activeTab === 'staff'" class="absolute bottom-0 left-0 right-0 h-0.5 bg-[#F8BE17] rounded-t-md"></div>
          </button>
          <button 
          ...
          >
            ...
            <div v-if="activeTab === 'external'" class="absolute bottom-0 left-0 right-0 h-0.5 bg-[#F8BE17] rounded-t-md"></div>
          </button>
        </div>
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-gray-100">
              ...
              >
                ...
                <td class="px-6 py-4 text-sm text-gray-600 font-mono">{{ row.identifier || 'N/A' }}</td>
        ...
        <div class="px-6 py-4 border-t border-gray-200 flex items-center justify-between bg-gray-50/50">
          <button class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-[#5C001F] focus:border-transparent">
            [Prev]
          </button>
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-md max-w-7xl mx-auto w-full mb-4 flex items-center justify-between">
      ...
      <div class="flex space-x-4">
        <button class="px-6 py-2.5 bg-white border border-gray-300 text-gray-700 font-bold rounded-lg hover:bg-gray-50 transition-colors text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-200">
          Cancel
        </button>
        <button 
          @click="handleConfirm"
